...
# Functions.
def varAndMono(population, toolbox, cxpb, mutpb):
  """This is the monophyletic version of the varAnd operator.
  ...
  # Apply inversion and mutation on the offspring
...
def varOrMono(population, toolbox, lambda_, cxpb, mutpb):
  """This is the monophyletic reproduction version of the varOr operator.
...
def eaMuPlusLambdaMono(population, toolbox, mu, lambda_, cxpb, mutpb, ngen, stats=None, halloffame=None, verbose=__debug__):
  """This is the monophyletic version of the :math:`(\mu + \lambda)`
  ...
  *ngen* generations are done, the algorithm returns a tuple with the final
  ...
  for gen in range(1, ngen + 1):
    # Vary the population
    offspring = varOrMono(population, toolbox, lambda_, cxpb, mutpb)
    # Evaluate the individuals with an invalid fitness
